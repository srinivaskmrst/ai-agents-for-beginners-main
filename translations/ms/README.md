...
![AI Agents for Beginners](../../translated_images/ms/repo-thumbnailv2.06f4a48036fde647.webp)
...
>
> Repositori ini mengandungi lebih 50 terjemahan bahasa yang secara signifikan meningkatkan saiz muat turun. Untuk klon tanpa terjemahan, gunakan sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
Kursus ini mengandungi pelajaran yang merangkumi asas-asas membina Ejen AI. Setiap pelajaran merangkumi topik tersendiri jadi mula dari mana-mana yang anda suka!

Terdapat sokongan pelbagai bahasa untuk kursus ini. Pergi ke [bahasa tersedia kami di sini](#-multi-language-support).

Jika ini kali pertama anda membina dengan model AI Generatif, lihat kursus [Generative AI For Beginners](https://aka.ms/genai-beginners) kami, yang termasuk 21 pelajaran tentang membina dengan GenAI.

Jangan lupa untuk [berbintang (🌟) repo ini](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) dan [fork repo ini](https://github.com/microsoft/ai-agents-for-beginners/fork) untuk menjalankan kod.
...
Kursus ini menggunakan kerangka dan perkhidmatan Ejen AI berikut dari Microsoft:

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Azure AI Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Beberapa contoh kod juga menyokong penyedia alternatif yang kompatibel dengan OpenAI seperti [MiniMax](https://platform.minimaxi.com/), yang menawarkan model konteks besar (sehingga 204K token). Lihat [Penetapan Kursus](./00-course-setup/README.md) untuk butiran konfigurasi.
...
| Membangun Ejen AI yang Dipercayai             | [Pautan](./06-building-trustworthy-agents/README.md) | [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Pautan](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Corak Reka Bentuk Metakognitif                 | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Ejen AI dalam Produksi                         | [Link](./10-ai-agents-production/README.md)        | [Video](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Menyebarkan Ejen yang Boleh Skala             | Akan Datang                            |                                                            |                                                                                        |
...
Jika anda terperangkap atau mempunyai sebarang soalan tentang membina aplikasi AI, sertai:
