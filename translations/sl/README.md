...
**Če želite dodatno podporo za druge jezike, so podprti jeziki navedeni [tukaj](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Ta tečaj vsebuje lekcije, ki pokrivajo osnove gradnje AI agentov. Vsaka lekcija obravnava svojo temo, zato začnite kjer želite!

Za ta tečaj je na voljo podpora za več jezikov. Obiščite naše [razpoložljive jezike tukaj](#-multi-language-support).

Če je to vaš prvič, da uporabljate Generativne AI modele, si oglejte naš tečaj [Generativni AI za začetnike](https://aka.ms/genai-beginners), ki vključuje 21 lekcij o gradnji z GenAI.

Ne pozabite [označiti (🌟) tega repozitorija](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) in [forkati ta repozitorij](https://github.com/microsoft/ai-agents-for-beginners/fork), da lahko poženete kodo.

### Spoznajte druge učence, dobite odgovore na vaša vprašanja

Če se zataknete ali imate vprašanja o gradnji AI agentov, se pridružite našemu namenskemu kanalu Discord v [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Kaj potrebujete

Vsaka lekcija v tem tečaju vsebuje primere kode, ki jih lahko najdete v mapi code_samples. Lahko si [forkate ta repozitorij](https://github.com/microsoft/ai-agents-for-beginners/fork) za ustvarjanje svoje kopije.

Primeri kode v teh vajah uporabljajo Microsoft Agent Framework s storitvijo Azure AI Foundry Agent Service V2:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Potreben Azure račun

Ta tečaj uporablja naslednje AI agentne okvire in storitve podjetja Microsoft:

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Azure AI Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Nekateri primeri kode podpirajo tudi alternativne ponudnike, združljive z OpenAI, kot je [MiniMax](https://platform.minimaxi.com/), ki nudi modele z velikim kontekstom (do 204K tokenov). Podrobnosti o konfiguraciji so v [Course Setup](./00-course-setup/README.md).

Za več informacij o zagonu kode za ta tečaj obiščite [Course Setup](./00-course-setup/README.md).

## 🙏 Želite pomagati?

Imate predloge ali ste našli pravopisne ali druge napake v kodi? [Odprite težavo (issue)](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ali [ustvarite pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Vsaka lekcija vključuje

- Pisni učni material v README in kratek video
...
| Razumevanje AI agentnih oblikovnih vzorcev   | [Povezava](./03-agentic-design-patterns/README.md) | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Povezava](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Oblikovni vzorec uporabe orodij              | [Povezava](./04-tool-use/README.md)               | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Povezava](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Večagentni oblikovni vzorec                     | [Povezava](./08-multi-agent/README.md)            | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Povezava](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Uporaba agentskih protokolov (MCP, A2A in NLWeb) | [Povezava](./11-agentic-protocols/README.md)          | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Povezava](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Upravljanje agentskega spomina            | [Povezava](./13-agent-memory/README.md)       |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                     |                                                                                        |
...
| Implementacija razširljivih agentov       | Kmalu na voljo                            |                                                            |                                                                                        |
...
### Serija Copilot
[![Copilot za AI dvojno programiranje](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Licenčno pogodbo za prispevke (CLA), ki izjavlja, da imate pravico in dejansko dovoljujete uporabo vašega
prispevka. Za podrobnosti obiščite <https://cla.opensource.microsoft.com>.

Ko oddate pull request, bo CLA bot samodejno ugotovil, ali morate predložiti
CLA in na ustrezen način označil PR (npr. preverjanje stanja, komentar). Preprosto sledite navodilom,
ki jih poda bot. To boste morali narediti le enkrat za vse repozitorije, ki uporabljajo naš CLA.
...
[Microsoftovim smernicam za blagovne znamke in blagovne znamke](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Vsaka uporaba blagovnih znamk ali logotipov tretjih oseb je predmet pravil tistih tretjih oseb.
...
Ta dokument je bil preveden z uporabo AI prevajalske storitve [Co-op Translator](https://github.com/Azure/co-op-translator). Čeprav si prizadevamo za natančnost, vas prosimo, da upoštevate, da lahko avtomatizirani prevodi vsebujejo napake ali netočnosti. Izvirni dokument v njegovem izvornih jeziku naj velja za avtoritativni vir. Za kritične informacije priporočamo strokovni človeški prevod. Ne prevzemamo odgovornosti za kakršne koli nesporazume ali napačne interpretacije, ki izhajajo iz uporabe tega prevoda.
