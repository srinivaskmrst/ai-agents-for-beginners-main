...
>
> Ez a tárhely több mint 50 nyelvre lefordított fájlokat tartalmaz, ami jelentősen megnöveli a letöltési méretet. Ha lefordítások nélkül szeretnéd klónozni, használd a sparse checkout-ot:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> Így minden meglesz, amire szükséged van a tanfolyam elvégzéséhez, sokkal gyorsabb letöltéssel.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**Ha további fordítási nyelvek támogatását szeretnéd, azok listája [itt található](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Ez a tanfolyam az AI Ügynökök építésének alapjait tárgyalja leckéken keresztül. Minden lecke a maga témakörét fedi le, szóval kezdj ott, ahol szeretnéd!

A tanfolyam többnyelvű támogatással rendelkezik. Lásd a [rendelkezésre álló nyelveket itt](#-multi-language-support).
...
Ne felejtsd el [🌟 csillaggal jelölni ezt a tárhelyet](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst), és [forkolni ezt a tárhelyet](https://github.com/microsoft/ai-agents-for-beginners/fork), hogy futtathasd a kódot.

### Ismerkedj meg más tanulókkal, kapj választ a kérdéseidre

Ha elakadsz vagy bármilyen kérdésed van az AI Ügynökök építésével kapcsolatban, csatlakozz a dedikált Discord csatornánkhoz a [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) szerveren.

### Mire lesz szükséged

A tanfolyam minden leckéjéhez tartoznak kódpéldák, amelyek a code_samples mappában találhatók. [Forkold ezt a tárhelyet](https://github.com/microsoft/ai-agents-for-beginners/fork), hogy elkészítsd a saját példányodat.

Ezek a kódpéldák a Microsoft Agent Frameworköt használják az Azure AI Foundry Agent Service V2-vel:
...
Néhány kódminta alternatív, OpenAI-kompatibilis szolgáltatókat is támogat, például a [MiniMax](https://platform.minimaxi.com/), amely nagy kontextusú modelleket kínál (akár 204 ezer tokens). A konfiguráció részleteiért lásd a [Tanfolyam Beállítása](./00-course-setup/README.md) részt.

A tanfolyam kódjának futtatásával kapcsolatos további információkért lásd a [Tanfolyam Beállítása](./00-course-setup/README.md) fejezetet.

## 🙏 Szeretnél segíteni?

Van ötleted, vagy találtál helyesírási vagy kódhibát? [Nyiss egy issue-t](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) vagy [Hozz létre egy pull requestet](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Python kódpéldákat a Microsoft Agent Framework és Azure AI Foundry használatával
...
| Mesterséges intelligencia ügynökök éles környezetben                      | [Link](./10-ai-agents-production/README.md)        | [Videó](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Köszönet [Shivam Goyal](https://www.linkedin.com/in/shivam2003/)-nak a fontos kódmintákért, amelyek bemutatják az Agentic RAG-et.

## Hozzájárulás

Ez a projekt szívesen fogad hozzájárulásokat és javaslatokat. A legtöbb hozzájáruláshoz el kell fogadnia egy
Hozzájárulói Licenc Szerződést (CLA), amely kijelenti, hogy joga van és ténylegesen megadja nekünk
a hozzájárulásának felhasználási jogát. Részletekért látogasson el a <https://cla.opensource.microsoft.com> oldalra.

Amikor egy pull request-et benyújt, egy CLA bot automatikusan eldönti, hogy szükséges-e CLA bemutatása,
és megfelelően jelöli a PR-t (pl. állapot ellenőrzés, hozzászólás). Csak kövesse a bot utasításait.
Ezt csak egyszer kell megtennie az összes CLA-t használó tárolónál.
...
lépjen kapcsolatba a [opencode@microsoft.com](mailto:opencode@microsoft.com) címen további kérdésekkel vagy kommentárokkal.

## Védjegyek

Ez a projekt tartalmazhat projektekhez, termékekhez vagy szolgáltatásokhoz kapcsolódó védjegyeket vagy logókat. A Microsoft
védjegyek vagy logók engedélyezett használata az alábbiak szerint történhet, és be kell tartania
a [Microsoft védjegy- és márkahasználati útmutatót](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
A Microsoft védjegyek vagy logók használata a projekt módosított verzióiban nem okozhat félreértést vagy azt, hogy a Microsoft támogatná.
Harmadik féltől származó védjegyek vagy logók használata a harmadik fél szabályzatai szerint történik.
